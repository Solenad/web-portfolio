# about-catppuccin-theme Specification

## Purpose

Defines the visual theme of the About window content: Catppuccin Macchiato palette, Consolas monospace typography, frosted glass panels, and a dark lightbox modal.
